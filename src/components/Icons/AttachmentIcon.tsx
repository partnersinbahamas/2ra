...
const AttachmentIcon: React.FC<TIcon> = ({ className, color, size, style, withBox }) => {
  switch (size) {
    case 'SMALL':
      return (
        <SmallSvg
          xmlns="http://www.w3.org/2000/svg"
          viewBox={withBox ? '-1.5 -2 22 24' : '1 0.5 16.7 19'}
          style={style}
          fill={color}
          className={className}
        >
          <g clipPath="url(#clip0_1306_3530)">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    case 'MEDIUM':
      return (
        <MediumSvg
          xmlns="http://www.w3.org/2000/svg"
          viewBox={withBox ? '-1.5 -1.5 24 26' : '1 0.5 19 21'}
          style={style}
          fill={color}
          className={className}
        >
          <g clipPath="url(#clip0_1306_3532)">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
    ...
    default:
      return (
        <LargeSvg
          xmlns="http://www.w3.org/2000/svg"
          viewBox={withBox ? '-1 -1 30 32' : '1 0.5 26 28'}
          style={style}
          fill={color}
          className={className}
        >
          <g clipPath="url(#clip0_1306_3534)">
            <path
              fillRule="evenodd"
              clipRule="evenodd"
